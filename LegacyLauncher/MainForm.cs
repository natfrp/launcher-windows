...
namespace LegacyLauncher
{
    public partial class MainForm : Form
    {
        ...
        private void label_update_Click(object sender, EventArgs e) => Model.ConfirmUpdate(Model.SimpleFailureHandler, Model.SimpleConfirmHandler, Model.SimpleWarningHandler);
